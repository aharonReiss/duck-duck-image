            ...
            {images && images.map((item:Image,index) => {
                ...
                <div className='manageImg-container' onClick={() => toggleManageImage(index)}>
                  <div className='manageImg'>
                    <img src={`${process.env.PUBLIC_URL}/img/manageImg.svg`} alt="" />
                  </div>
                  {item.openManageImg &&<div className='listmanageImg'>
                       <div className='action-container'>
                          ...
                          <div className='img-action'>
                                <img src={`${process.env.PUBLIC_URL}/img/copyImg.svg`} alt="" className='img-15px'/>
                          </div>
                       </div> 
                       <div className='action-container' onClick={() => onClickCopyUrl(index)}>
                          ...
                          <div className='img-action'>
                                <img src={`${process.env.PUBLIC_URL}/img/copyUrlImg.svg`} alt="" className='img-18px'/>
                          </div>
                       </div> 
                       <div className='action-container' onClick={() => deleteImg(index)}>
                          ...
                          <div className='img-action'>
                                <img src={`${process.env.PUBLIC_URL}/img/deleteImg.svg`} alt="" className='img-18px'/>
                          </div>
                       </div>  
                  </div>}
                </div>
